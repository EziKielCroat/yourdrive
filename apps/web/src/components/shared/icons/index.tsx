...
export const FileAudioIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
    <polyline points="14 2 14 8 20 8" />
    <path d="M10 13a2 2 0 1 0 4 0v-3a2 2 0 1 0-4 0v3z" />
  </Svg>
);
...
export const FileQuestionIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
    <polyline points="14 2 14 8 20 8" />
    <path d="M9.09 13a3 3 0 0 1 5.83 1c0 2-3 3-3 3" />
...
export const ClipboardCopyIcon = (p: IconProps) => (
  <Svg {...p}>
...
export const Edit3Icon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M12 20h9" />
...
export const RotateCwIcon = (p: IconProps) => (
  <Svg {...p}>
    <polyline points="23 4 23 10 17 10" />
    <path d="M20.49 9A9 9 0 1 1 5.64 5.64L1 10" />
  </Svg>
);
...
export const TwitterIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M4 4l11.733 16H20L8.267 4zM4 20l6.768-6.768M20 4l-6.768 6.768" />
  </Svg>
);
...
// ─── Navigation icons (local branded variants) ────────────────────────────────
...
export const UploadFolderIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" />
...
export const SmallFolderIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" />
  </Svg>
);

export const RecycleBinIcon = (p: IconProps) => (
  <Svg {...p}>
    <polyline points="3 6 5 6 21 6" />
...
export const SharedWithYouIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
    <circle cx="9" cy="7" r="4" />
    <path d="M23 21v-2a4 4 0 0 0-3-3.87" />
...
export const NotificationCenterIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" />
    <path d="M13.73 21a2 2 0 0 1-3.46 0" />
  </Svg>
...
export const RecentlyEditedIcon = (p: IconProps) => (
  <Svg {...p}>
    <circle cx="12" cy="12" r="10" />
    <polyline points="12 6 12 12 16 14" />
  </Svg>
...
export const HelpCenterIcon = (p: IconProps) => (
  <Svg {...p}>
    <circle cx="12" cy="12" r="10" />
    <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" />
    <line x1="12" y1="17" x2="12.01" y2="17" />
...
export const DevicesIcon = (p: IconProps) => (
  <Svg {...p}>
    ...
    <path d="M18 7h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-1" />
